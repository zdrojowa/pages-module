            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header clearfix">
                        <h4 class="card-title float-left">Dostępne sekcje</h4>
                        ...
                        @foreach($sections as $section)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        <span class="flag-icon flag-icon-{{ $section->lang }}"></span>
                                    @endif
                                </td>
                                <td>
                                    @php
                                    ...
                                    @endphp
                                    @foreach($langs as $ln)
                                        @if ($section->lang !== $ln->short_name)
                                            @if (isset($translations[$ln->short_name]))
                                                <a href="{{ route('PagesModule::editSection', [
                                                            'section' => $translations[$ln->short_name]
                                                        ]) }}">
                                                    @if($ln->short_name === 'en')
                                                        <span class="flag-icon flag-icon-gb"></span>
                                                    @else
                                            ...
                                            @else
                                                <a href="{{ route('PagesModule::addSectionTranslation', [
                                                            'section' => $section->id,
                                                            'lang'    => $ln->short_name
                                                        ]) }}">
                                                    @if($ln->short_name === 'en')
                                ...
                                <td>
                                    <div>
                                        ...
                                        <a href="{{ route('PagesModule::destroySection', [
                                            'section' => $section->_id
